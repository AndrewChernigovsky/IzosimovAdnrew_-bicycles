...
const 
  ...
  // userNameMainForm.addEventListener('change', function() {
  //     if (isValidName(userNameMainForm)){
  //       if(userNameMainForm.classList.contains('success')) {
  ...
  // userPhoneMainForm.addEventListener('change', function() {
  //     if (isValidPhone(userPhoneMainForm)){
  //       if(userPhoneMainForm.classList.contains('success')) {
